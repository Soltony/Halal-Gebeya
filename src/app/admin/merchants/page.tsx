    ...
    <div className="flex-1 space-y-4 p-8 pt-6">
      ...
      <div className="flex justify-end">
        <Link href="/admin/merchants/items/new">
          <Button className="bg-primary hover:bg-primary/90"><PlusCircle className="mr-2 h-4 w-4" />Add Item</Button>
        </Link>
      </div>
              ...
              <TableRow key={item.id}>
                ...
                <TableCell>
                  <Badge variant="outline" className={
                    ...
                    {item.sellingOption === 'DIRECT_ONLY' ? IFB.directOnly : item.sellingOption === 'BOTH' ? IFB.islamicBnplAndDirect : IFB.islamicBnplOnly}
                  </Badge>
                </TableCell>
