...
import { BRAND_SECONDARY } from '@/lib/brand-colors';
...
export function RepaymentDialog({ isOpen, onClose, onConfirm, loan, totalBalanceDue, providerColor = BRAND_SECONDARY, taxConfigs, asOfDate }: RepaymentDialogProps) {
                        ...
                        <div className="text-center text-sm text-muted-foreground space-y-1">
                            {isInstallmentPayment && activeInstallment && (
                                <div className="text-xs space-y-1">
                                    <p>
                                        Paying installment {activeInstallment.installmentNumber} ({IFB.lateCharge.toLowerCase()} shown as of today)
                                    </p>
