...
export const SMS_PLACEHOLDERS = [
    { token: '{{borrowerName}}', description: 'Customer\'s full name' },
    { token: '{{borrowerId}}', description: 'Customer ID / phone number' },
    { token: '{{loanAmount}}', description: 'Original financing amount' },
    { token: '{{outstandingAmount}}', description: 'Current outstanding balance' },
    { token: '{{dueDate}}', description: 'Financing due date' },
    { token: '{{productName}}', description: 'Financing product name' },
    { token: '{{providerName}}', description: 'Financing partner name' },
    { token: '{{daysOverdue}}', description: 'Number of days past due date' },
    { token: '{{disbursedDate}}', description: 'Date financing was released' },
    { token: '{{penaltyAmount}}', description: 'Current late settlement charge amount' },
] as const;
