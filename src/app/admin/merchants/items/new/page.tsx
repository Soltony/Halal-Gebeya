    ...
    <div className="flex-1 space-y-4 p-8 pt-6">
      <Card>
        <CardContent className="pt-6">
          ...
          <p className="text-muted-foreground mb-6">{IFB.itemDetailsShownInShop}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <Select value={sellingOption} onValueChange={setSellingOption}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="BNPL_ONLY">{IFB.islamicBnplOnly}</SelectItem>
                  <SelectItem value="DIRECT_ONLY">{IFB.directPaymentOnly}</SelectItem>
                  <SelectItem value="BOTH">{IFB.islamicBnplBothSelect}</SelectItem>
                </SelectContent>
              </Select>
            </div>
            ) : (
            <div>
              <Label>Selling Option</Label>
              <Input value={IFB.directPaymentOnly} disabled />
            </div>
            )}
            <div>
