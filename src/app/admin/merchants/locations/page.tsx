          ...
          <div className="flex justify-end mb-4">
            <Dialog open={dialogOpen} onOpenChange={(o) => { setDialogOpen(o); if (!o) { setEditing(null); setName(''); setAddress(''); setContactInfo(''); } }}>
              <DialogTrigger asChild>
                <Button className="bg-primary hover:bg-primary/90"><PlusCircle className="mr-2 h-4 w-4" />Add Location</Button>
              </DialogTrigger>
              <DialogContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <Button className="bg-primary hover:bg-primary/90" onClick={handleSave} disabled={loading || !name.trim()}>
                      {loading ? 'Saving...' : 'Save'}
                    </Button>
                  </div>
                </div>
