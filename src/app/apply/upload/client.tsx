...
export function UploadClient({ application: initialApplication }: UploadClientProps) {
    ...
    const providerColor = application.product.provider.colorHex || BRAND_PRIMARY;
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            {requiredDocs.length === 0 && (
                                <p className="text-center text-muted-foreground py-8">{IFB.noDocumentsRequiredForProduct}</p>
                            )}
                        </CardContent>
                        <CardFooter>
                            <Button 
