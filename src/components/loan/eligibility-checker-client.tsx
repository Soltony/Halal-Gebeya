...
export function EligibilityCheckerClient({ borrowers, providers }: EligibilityCheckerClientProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
        <header className="sticky top-0 z-40 w-full border-b bg-primary shadow-sm">
            <div className="container flex h-16 items-center">
                <div className="mr-4 flex items-center gap-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white overflow-hidden p-1.5">
                        <Image 
                          src="/logo.png" 
                          alt="Logo" 
                          width={32} 
        ...
        <main className="flex-1 py-8 md:py-12">
            <div className="container max-w-7xl">
                 <Card>
                    <CardHeader>
                        <CardTitle>{IFB.selectCustomerProfile}</CardTitle>
                        <CardDescription>
