            ...
            <CardContent className="pt-6 space-y-6">
                ...
                <div className="space-y-2">
                    <div className="flex items-center justify-between rounded-md border p-4">
                        <div>
                            <Label htmlFor={`tax-inclusive-${config.id}`} className="font-medium">{IFB.inclusiveTaxDeductFromFinancing}</Label>
                            <p className="text-xs text-muted-foreground">{IFB.inclusiveTaxDeductFromFinancingHelp}</p>
                        </div>
                        <Switch
    ...
    return (
        <div className="flex-1 space-y-4 p-8 pt-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">{IFB.leviesTax}</h2>
                    <p className="text-muted-foreground">{IFB.taxAppliesToFinancingComponentsHelp}</p>
                </div>
                {canCreate ? (
