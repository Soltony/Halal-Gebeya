    ...
    <>
      <div className="flex-1 space-y-4 p-8 pt-6">
        <h2 className="text-3xl font-bold tracking-tight">
          {IFB.reversalApprovalsPageTitle}
        </h2>
        <Card>
          <CardHeader>
            <CardTitle>{IFB.reversalApprovalsCardTitle}</CardTitle>
            <CardDescription>
              {IFB.reversalApprovalsCardDescription}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              ...
              <TableBody>
                {changes.length > 0 ? (
                  changes.map((change) => {
                    ...
                    const displaySubtype = isPostedLoan ? IFB.reversalPostedFinancingShort : "";
                    return (
        ...
        <DialogContent>
          ...
          <div className="py-4">
            <Textarea
              ...
              placeholder={IFB.reversalRejectPlaceholderFailedRelease}
