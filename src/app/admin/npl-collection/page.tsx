  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">{IFB.npfCollection}</h2>
          <p className="text-muted-foreground">
            Digital financing settlement workflow with the Core Banking System (CBS). Upload daily NPF lists, receive credit notifications, and auto-debit customers when funds are available.
          </p>
        </div>
      </div>
