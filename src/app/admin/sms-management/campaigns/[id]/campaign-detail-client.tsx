                ...
                <Card>
                    ...
                    <CardContent className="space-y-2">
                        ...
                        {(criteria.loanAgeFrom !== undefined || criteria.loanAgeTo !== undefined) && (
                            <div>
                                <span className="text-sm text-muted-foreground">{IFB.financingAgeDaysLabel} </span>
                                <span className="font-medium">
                        ...
                        {criteria.repaymentStatus && (
                            <div>
                                <span className="text-sm text-muted-foreground">{IFB.settlementStatusLabel} </span>
                                <span className="font-medium">{criteria.repaymentStatus}</span>
                            </div>
                        )}
                        {Object.keys(criteria).length === 0 && (
                            <p className="text-muted-foreground">{IFB.allFacilitiesNoFilters}</p>
                        )}
                    </CardContent>
                </Card>
            </div>
