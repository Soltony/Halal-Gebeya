...
export function LoanSummaryCard({ maxLoanLimit, availableToBorrow, color = BRAND_PRIMARY, isLoading = false }: LoanSummaryCardProps) {
      ...
      <div className="relative z-10 flex flex-row items-center justify-between w-full">
        ...
        <div className="text-left">
            <div className="flex items-center gap-2">
                <p className="text-sm opacity-80 mb-1">{IFB.approvedFinancingLimit}</p>
        ...
        <div className="text-right">
            <div className="flex items-center gap-2 justify-end">
                <p className="text-sm opacity-80 mb-1">{IFB.availableFinancing}</p>
