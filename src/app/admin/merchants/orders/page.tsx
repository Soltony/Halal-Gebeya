    ...
    try {
      ...
      toast({
        ...
        description: nextStatus === 'CANCELLED'
          ? IFB.orderCancelledNotifyCustomer
          ...
          <div className="flex flex-col gap-4 xl:flex-row xl:items-end">
            <div className="min-w-[260px] flex-1">
              ...
              <div className="relative">
                ...
                <Input
                  placeholder={IFB.searchMerchantOrdersPlaceholder}
                  value={searchInput}
              ...
              >
                ...
                <SelectContent>
                  {PAYMENT_TYPE_OPTIONS.map((option) => (
                    <SelectItem key={option} value={option}>
                      {option === ALL_FILTER_VALUE
                        ? 'All types'
                        : option === 'BNPL'
                          ? IFB.islamicBnplBadge
                          : IFB.directPayment}
                    </SelectItem>
                  ))}
                </SelectContent>
                      ...
                      <TableRow key={order.id}>
                        ...
                        <TableCell>
                          <Badge
                            ...
                            variant="outline"
                          >
                            {order.paymentType === 'DIRECT' ? IFB.directPayment : IFB.islamicBnplBadge}
                          </Badge>
                        </TableCell>
                        <TableCell>
