  ...
  return (
    <div className="max-w-2xl mx-auto">
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle>Check your {IFB.financingEligibility.toLowerCase()}</CardTitle>
        ...
        <CardContent>
          {result && !result.isEligible && (
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  {result.reason || "We're sorry, but you are not eligible for financing at this time."}
                </AlertDescription>
              </Alert>
          )}
        </CardContent>
        <CardFooter>
          <Button onClick={onCheck} className="w-full" disabled={isLoading}>
            ...
            Check {IFB.financingEligibility.toLowerCase()}
          </Button>
        </CardFooter>
      </Card>
    </div>
