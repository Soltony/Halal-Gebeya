    ...
    <div className="flex-1 space-y-6 p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex flex-wrap gap-2">
              <Badge variant="outline" className="bg-amber-50 text-amber-700 border-amber-300">{IFB.islamicBnplBadge}: {data.paymentTypeBreakdown.bnpl}</Badge>
        ...
        <CardContent>
          <div className="flex items-end gap-[2px] h-40">
            {data.revenueByDay.map((day, i) => (
              ...
              >
                <div
                  className="bg-secondary hover:bg-secondary/85 rounded-t-sm transition-colors w-full"
                  ...
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      <Badge variant="outline" className={order.paymentType === 'BNPL' ? 'bg-amber-50 text-amber-700 border-amber-300' : 'bg-blue-50 text-blue-700 border-blue-300'}>
                        {order.paymentType === 'BNPL' ? IFB.islamicBnplBadge : IFB.directOnly}
                      </Badge>
                    </TableCell>
