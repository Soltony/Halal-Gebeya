...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        const behavioralParameters = [
            { value: 'totalLoansCount', label: IFB.paramTotalFinancingCount, type: 'number', options: [] },
            { value: 'loansOnTime', label: IFB.paramFinancingOnTime, type: 'number', options: [] },
            { value: 'loansLate', label: IFB.paramFinancingLate, type: 'number', options: [] },
            { value: 'loansEarly', label: IFB.paramFinancingEarly, type: 'number', options: [] },
