  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold tracking-tight md:text-4xl">Choose a {IFB.financingPartner.toLowerCase()}</h2>
        <p className="text-lg text-muted-foreground mt-2">Select a partner to see their available {IFB.financingProducts.toLowerCase()}.</p>
      </div>
