            ...
            <div className="flex justify-end mb-4">
              <Dialog open={merchantDialogOpen} onOpenChange={(o) => { setMerchantDialogOpen(o); if (!o) resetMerchantForm(); }}>
                <DialogTrigger asChild>
                  <Button className="bg-primary hover:bg-primary/90"><PlusCircle className="mr-2 h-4 w-4" />Add Merchant</Button>
                </DialogTrigger>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          <Label className="text-base">{IFB.branchEnableIslamicBnpl}</Label>
                          <p className="text-sm text-muted-foreground">{IFB.branchEnableIslamicBnplHelp}</p>
                        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button className="bg-primary hover:bg-primary/90" onClick={handleCreateMerchantUser} disabled={loading}>
                  Submit for Approval
                </Button>
              </div>
            </CardContent>
          ...
          <CardContent className="pt-6">
            <div className="flex justify-end mb-4">
              <Dialog open={categoryDialogOpen} onOpenChange={(o) => { setCategoryDialogOpen(o); if (!o) { setEditingCategory(null); setCategoryName(''); } }}>
                <DialogTrigger asChild>
                  <Button className="bg-primary hover:bg-primary/90"><PlusCircle className="mr-2 h-4 w-4" />Add Category</Button>
                </DialogTrigger>
                <DialogContent>
