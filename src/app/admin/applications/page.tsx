        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Please provide a reason for requesting revisions. {IFB.revisionNoteShownToCustomer}</DialogDescription>
                </DialogHeader>
                <div className="py-4">
    ...
    const handleStatusUpdate = async (revisionReason?: string) => {
        ...
        const successMessage =
          newStatus.toLowerCase() === 'approved'
            ? IFB.applicationApprovedFinancingReleased(borrowerName)
            : IFB.applicationSentBackRevision(borrowerName);
    ...
    return (
        <>
            <div className="flex-1 space-y-4 p-8 pt-6">
                <h2 className="text-3xl font-bold tracking-tight">{IFB.financingApplicationsHeading}</h2>
                <p className="text-muted-foreground">
                    {IFB.financingApplicationsIntro}
                </p>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow>
                                    ...
                                    <TableHead>{IFB.financingProduct}</TableHead>
                                    <TableHead>{IFB.financingPartner}</TableHead>
                                    <TableHead className="text-right">{IFB.financingAmount}</TableHead>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            {IFB.approveAutoReleaseFinancingWarning(actionState.application?.borrowerName ?? '')}
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
