...
const FIELD_LABELS: Record<string, string> = {
  ...
  bnplEnabled: IFB.islamicBnplEnabledField,
  status: 'Status',
  iconUrl: 'Icon',
  merchantId: 'Merchant',
  categoryId: 'Category',
...
function formatSellingOption(v: string): string {
  switch (v) {
    case 'BNPL_ONLY': return IFB.islamicBnplOnly;
    case 'DIRECT_ONLY': return IFB.directPaymentOnly;
    case 'BOTH': return IFB.islamicBnplAndDirect;
    default: return v;
  }
}
