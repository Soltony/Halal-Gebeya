...
import { BRAND_PRIMARY, BRAND_SECONDARY } from "@/lib/brand-colors";
  ...
  const recalculateEligibility = useCallback(
    async (providerId: string) => {
      ...
      try {
        ...
        const defaultReason =
          IFB.couldNotCalculateEligibility;
  ...
  const handleConfirmRepayment = async (amount: number) => {
    ...
    try {
      ...
      toast({
        ...
        description: IFB.paymentTowardsFinancing(formatCurrency(amount)),
      });
    ...
    <>
                ...
                <Link
                  ...
                  style={{
                    backgroundColor: selectedProvider
                      ...
                      : `${BRAND_SECONDARY}33`,
                    color: selectedProvider?.colorHex || BRAND_PRIMARY,
                  }}
                >
                  <span>{IFB.financingHistory}</span>
              ...
              <div className="grid gap-8 grid-cols-1 mt-4">
                <div className="md:col-span-2">
                  {selectedProvider && (
                    <Card>
                      <CardHeader>
                        <CardTitle>Available financing products</CardTitle>
                        <CardDescription>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        {selectedProvider.products.filter(
                          ...
                          <p className="text-sm text-muted-foreground text-center py-8">
                            No active financing products available from this
                            provider.
                          </p>
                        )}
                      </CardContent>
      ...
      >
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            <DialogTitle>{IFB.shariaTermsTitle}</DialogTitle>
            <DialogDescription>
              {IFB.shariaTermsIntro(selectedProvider?.name ?? "the provider")}
            </DialogDescription>
          </DialogHeader>
      ...
      >
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            <DialogTitle>{IFB.selectFinancingReleaseAccount}</DialogTitle>
            <DialogDescription>
              {IFB.financingReleaseAccountHelp}
            </DialogDescription>
          </DialogHeader>
          {borrowerId && (
            <div className="mt-4">
